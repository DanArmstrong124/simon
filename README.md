...
- I found that the validators claim that my <head> tag and <body> tag have errors but searching over the code I cannot see why there is an issue in the slightest.
